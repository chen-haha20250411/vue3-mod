...
const views = {
  ...
  'system/data-permission-new/index': () => import('@/views/system/data-permission-new/index'),
  ...
  'data-platform/productAnalysis': () => import('@/views/data-platform/components/ProductPurchaseAnalysis'),
  'data-platform/TYCPProductAnalysis': () => import('@/views/data-platform/components/TYCPProductAnalysis'),
  ...
  'enterprise/user': () => import('@/views/enterprise/user/index'),
